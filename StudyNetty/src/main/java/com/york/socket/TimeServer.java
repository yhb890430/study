...
////                            break;
////                        }
//                        System.out.println("RECEIVE CONTENT FROM CLIENT:" + sb.toString());
...
//    }
    ...
    public static void main(String[] args) throws IOException{
        ...
        try {
            ...
            System.out.println("RECEIVE CONTENT FROM CLIENT:" + sb.toString());
            currentTime = "QUERY TIME ORDER".equalsIgnoreCase(sb.toString()) ? new Date(System.currentTimeMillis()).toString() : "BAR ORDER";
            // 自带flush操作
