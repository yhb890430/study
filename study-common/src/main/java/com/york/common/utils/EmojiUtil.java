 ...
 * @author York.yuan
 * @version <1.0>
 * @description emoji图片工具类(参考:https://github.com/vdurmont/emoji-java)
 * @createdate 2018/8/23 15:43
 **/
public final class EmojiUtil {

    public final static String UNICODE_PATTERN= "["+
     ...
     * @return
     */
    public static String delEmoji(String source){
        try{
    ...
    public static String removeEmoji(String source){
        String res = EmojiParser.removeAllEmojis(source);
        return res;
    }
}
